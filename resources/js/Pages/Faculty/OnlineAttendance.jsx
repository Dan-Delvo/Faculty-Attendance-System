                            ...
                            <div className="p-5">
                                ...
                                <div className="flex items-start justify-between gap-3 mb-4">
                                    <div className="flex items-center gap-3">
                                        <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl text-white font-bold text-xs shadow-sm ${
                                            req.class_type === 'synchronous'
                ...
                <form onSubmit={handleCreate}>
                    ...
                    <div className="px-6 py-5 space-y-5 max-h-[60dvh] overflow-y-auto">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                <InputLabel value="Time Out" htmlFor="time_out" />
                                <TextInput
                                    id="time_out"
                                    type="time"
                                    className="mt-1 block w-full text-sm"
                        ...
                        {/* Screenshot: Time Out */}
                        <div>
                            <InputLabel value="Screenshot — Time Out (proof)" />
                            <div
